...
export default function Home(){
 ...
 const [form,setForm]=useState({name:'',contactPerson:'',mobile:'',reference:'',routeId:'',expected:'',lastYear:'',lastReceipt:'',amount:'',receiptNumber:'',collectionDate:new Date().toISOString().slice(0,10),mode:'Cash',pan:'',is80g:false,finalDonation:true,chequeNo:'',bankName:'',memberName:'',memberMobile:'',birthDate:'',newRoute:'',userName:'',userMobile:'',username:'',password:'',role:'Volunteer' as Role,userActive:true})
 const isAdmin=profile&&['Super Admin','Admin'].includes(profile.role);const isSuperAdmin=profile?.role==='Super Admin';const canDeleteDonor=!!profile&&['Super Admin','Admin','Treasurer'].includes(profile.role);const canDownloadReports=!!profile&&['Super Admin','Admin','Treasurer'].includes(profile.role)
...
*– राजस्थान युवक मंडळ, संगमनेर*`)
 ...
 function resetForm(){setForm({name:'',contactPerson:'',mobile:'',reference:'',routeId:'',expected:'',lastYear:'',lastReceipt:'',amount:'',receiptNumber:'',collectionDate:new Date().toISOString().slice(0,10),mode:'Cash',pan:'',is80g:false,finalDonation:true,chequeNo:'',bankName:'',memberName:'',memberMobile:'',birthDate:'',newRoute:'',userName:'',userMobile:'',username:'',password:'',role:'Volunteer',userActive:true})}
