...
*– राजस्थान युवक मंडळ, संगमनेर*`)
 ...
 {active==='members'&&canSeeRestrictedTabs&&<MemberManager supabase={supabase} orgId={orgId} members={members} canManage={canManageExpenses} isAdmin={!!isAdmin} onAdd={()=>{resetForm();setModal('member')}} onBulk={()=>{setPreview(null);setModal('importMembers')}} reload={()=>loadAll()} />}
 ...
 {active==='reports'&&<Reports donors={donors} receipts={receipts} canDownload={canDownloadReports}/>} {active==='paymentPending'&&canSeeRestrictedTabs&&<PendingPayments receipts={receipts} onSettle={settlePendingReceipt} onReminder={sendPaymentReminder}/>} {active==='daywise'&&<DaywiseReport receipts={receipts} date={dayReportDate} setDate={setDayReportDate}/>} 
